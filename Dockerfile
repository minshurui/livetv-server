...
ENV DATA=/data \
    ...
    PUBLIC_LIVETV_PORT=8081 \
    HUYA_CDN=AL \
    HUYA_CODEC=264 \
    HUYA_MAX_RATIO=2000 \
    HUYA_CACHE_TTL=30 \
    DOUYU_CACHE_TTL=30 \
    STREAM_READ_IDLE_SECONDS=10 \
    SYNC_CHANNELS_MINUTES=15 \
    PREWARM_PER_GROUP=2 \
    PREWARM_MAX_CHANNELS=16 \
    PREWARM_WORKERS=3 \
    SYNC_HUYA_EXTRA_GAME_IDS=2135 \
    SYNC_HUYA_EXTRA_PAGES=0 \
    SYNC_HUYA_WORKERS=6 \
    ...
    IPTV_VERIFY_TIMEOUT=12 \
    IPTV_VERIFY_WORKERS=6 \
    IPTV_URLS_PER_CHANNEL=2 \
    IPTV_BLOCKLIST="" \
    PYTHONUNBUFFERED=1 \
